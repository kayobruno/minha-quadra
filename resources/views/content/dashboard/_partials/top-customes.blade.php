<div class="card h-100">
  <div class="card-header d-flex align-items-center justify-content-between">
    <h5 class="card-title m-0 me-2">Melhores Clientes</h5>
  </div>
  <div class="card-body">
      ...
      <li class="d-flex mb-4 pb-1 align-items-center">
        <div class="avatar flex-shrink-0 me-3">
          <div class="avatar-wrapper">
            <div class="avatar avatar-sm me-2"><span class="avatar-initial rounded-circle bg-label-warning">FS</span></div>
          </div>
        </div>
        <div class="row w-100 align-items-center">
          <div class="col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
            <h6 class="mb-0 lh-sm">Fulano Silva</h6>
          </div>
          <div class="col-sm-4 col-lg-12 col-xxl-4 text-sm-end text-lg-start text-xxl-end">
            <div class="badge bg-label-secondary">R$ 1.250,99</div>
          </div>
        </div>
      </li>
      <li class="d-flex mb-4 pb-1 align-items-center">
